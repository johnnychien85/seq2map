...
namespace seq2map
{
    ...
    public:
        ...
        inline boost::shared_ptr<PosedProjection> GetPosedProjection() const { return boost::shared_ptr<PosedProjection>(new PosedProjection(GetExtrinsics(), m_intrinsics ? m_intrinsics->Clone() : ProjectionModel::Own())); }
